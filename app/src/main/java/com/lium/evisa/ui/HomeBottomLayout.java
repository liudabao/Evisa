...
public class HomeBottomLayout extends LinearLayout {
    ...
    public HomeBottomLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void populateTabLayout() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            final View tabView = LayoutInflater.from(getContext()).inflate(R.layout.ui_layout_tab_bottom, this, false);
            mIconLayouts[i] = tabView;
            TabIconView iconView = (TabIconView) tabView.findViewById(R.id.tab_icon);
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ((TabIconView) mIconLayouts[i].findViewById(R.id.tab_icon))
                        .transformPage(position == i ? 0 : 1);
                ((TextView) mIconLayouts[i].findViewById(R.id.tab_text))
